...
public class AdminGUI extends JFrame{
    ...
    private JButton buttonSearchUser;
    private JButton buttonAddUser;
    private JPanel panelSearchUser;
    private JTextField textSearchUserUserName;
    private JTable tableUsers;
    private JTextField textSearchUserSurname;
    private JButton buttonUsersClear;
    ...
    private JPopupMenu popupUsers=new JPopupMenu();
    ...
    public AdminGUI(User user) {
        add(mainPanel);
        setTitle(Support.ProjectTitle+" - ADMIN");
        setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
        setSize(1200, 500);
        setLocation(Support.setLocation("x", 1200), Support.setLocation("y", 500));
        setResizable(true);
        setVisible(true);
        ...
        comboSearchUserType.setSelectedItem(null);
        ...
        buttonAddUser.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                AddUserGUI addUserGUI =new AddUserGUI(null);
                addUserGUI.setVisible(true);

                addUserGUI.addWindowListener(new WindowAdapter() {
                    @Override
        ...
        buttonSearchUser.addActionListener(e -> {
            ...
            String name=textSearchUserName.getText().trim();
            String surname=textSearchUserSurname.getText().trim();
            String userName=textSearchUserUserName.getText().trim();
            String type=null;

            if (comboSearchUserType.getSelectedItem()!=null){

                type=comboSearchUserType.getSelectedItem().toString();

            }

            loadTableUsers(User.search(name,surname,userName,type));


        });
        buttonUsersClear.addActionListener(e -> {
            textSearchUserName.setText(null);
            textSearchUserSurname.setText(null);
            textSearchUserUserName.setText(null);
            comboSearchUserType.setSelectedItem(null);
    ...
    public void setTableUsers() {
            ...
            Object [] columnsUser={"ID","NAME", "SURNAME", "USERNAME", "MAIL", "PHONE", "PASSWORD", "USER TYPE"};
            modelUser.setColumnIdentifiers(columnsUser);
            rowsUsers=new Object [columnsUser.length];
            ...
            tableUsers.getTableHeader().setResizingAllowed(true);
    ...
    public void loadTableUsers(){
            ...
            for(User user :User.getUsers() ) {
                ...
                rowsUsers[i++]=user.getSurname();
                rowsUsers[i++]=user.getUserName();
                rowsUsers[i++]=user.getMail();
                rowsUsers[i++]=user.getPhone();
                rowsUsers[i++]=user.getPassword();
                rowsUsers[i++]=user.getUserType();

                modelUser.addRow(rowsUsers);
    ...
    public void setJPopupMenuUsers(JPopupMenu popupMenu) {
            ...
            tableUsers.addMouseListener(new MouseAdapter() {
                ...
                public void mousePressed(MouseEvent e) {
                    ...
                    int selectedRow=tableUsers.rowAtPoint(e.getPoint());
            ...
            popupMenu.add("Güncelle").addActionListener(new ActionListener() {
                ...
                public void actionPerformed(ActionEvent e) {
                    ...
                    try{
                        ...
                        AddUserGUI addUserGUI =new AddUserGUI(user);
                        addUserGUI.setVisible(true);
                        addUserGUI.addWindowListener(new WindowAdapter() {
                            @Override
                            public void windowClosed(WindowEvent e) {
